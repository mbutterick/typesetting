#lang racket
(require rackunit racket/runtime-path fontland fontland/subset)

#|
approximates
https://github.com/mbutterick/fontkit/blob/master/test/subset.js
|#
...
(test-case
 "should create a TTFSubset instance"
 (define subset (create-subset font))
 (check-true (ttf-subset? subset)))
